# NodeMCU API
## Platforms
- **[NodeMCU/ESP8266](esp8266.md)** (62 modules), supports ESP8266 based development boards, like Wemos D1 Mini, Adafruit HUZZAH ESP8266
- **[NodeMCU/ESP32](esp32.md)** (26 modules), supports ESP32 based development boards, like ESP-WROOM-32, LOLIN32 or LOLIN32 Lite
- **[NodeMCU/Linux](linux.md)** (7 modules), supports any device which runs Debian-based Linux distro (Raspbian, Armbian), incl. Raspberry Pi series (RPi 3, zero), Orange Pi series (OP Zero, OP Lite), NanoPi series (NP Neo)
